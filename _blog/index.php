...
require_once '../_views/conecta.php';
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Title -->
        <h1 class="mt-4"><?php echo $fetch['titulo'] ?></h1>

        <!-- Author -->
        <p class="lead">
          by
          <a href="#"><?php echo $fetch['autor'] ?></a>
        </p>

        <hr>

        <!-- Date/Time -->
        <p><?php echo $fetch['data'] ?></p>

        <hr>

        <!-- Preview Image -->
        <img class="img-fluid rounded" src="http://placehold.it/900x300" alt="<?php echo $fetch['descricao-img'] ?>">

        <hr>

        <!-- Post Content -->
        <p class="lead"><?php echo $fetch['post'] ?></p>
